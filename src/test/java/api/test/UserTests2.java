...
public class UserTests2 {
	...
	public void testPostUser() {
		...
		Response respone = UserEndPoints2.createUser(userPayload);
	...
	public void testUpdateUserByName() {
		...
		Response respone = UserEndPoints2.updateUser(this.userPayload.getUsername(), userPayload);
		respone.then().log().body().statusCode(200);
		System.out.println("Hi This is third Response");
		respone.then().log().all();
//		Assert.assertEquals(respone.getStatusCode(), 200);
		Response responeAfterUpdate = UserEndPoints2.readUser(this.userPayload.getUsername());
